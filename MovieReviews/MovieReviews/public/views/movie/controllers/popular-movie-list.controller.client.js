(
    function () {
        angular
            .module("WDP")
            .controller('popularmovieListCtrl', popularmovieListCtrl);

        function popularmovieListCtrl($route,UserService,MovieService, $location, $routeParams, $sce,isLoggedIn) {
            var model = this;
            ...
            function searchSortedMoviesByPageNumber(attr,order,pageNumber) {
                MovieService
                    ...
                    .then(function (configs) {
                        ...
                        var poster_config_path = baseURL + size;
                        MovieService
                            .getPopularMoviesSortedMoviesByPageNumber(attr, order,pageNumber)
                            .then(function (response) {
                                getMovieInfo(response,poster_config_path);
                            });
                    });
                ...
                MovieService
                    ...
                    .then(function (configs) {
                        ...
                        if((model.attribute === "" || model.attribute === undefined)
                            ...
                            MovieService
                                .getPopularMoviesByPageNumber(pageNumber)
                                .then(function (response) {
